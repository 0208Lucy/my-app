...
function MyButton(props) {
  ...
  return (
    <div className="buttons">
      <div>
        <button className="btn btn-action" onClick={handleclick} value="c">
          C
        </button>
        <button className="btn btn-action" onClick={handleclick} value="+/-">
          +/-
        </button>
        <button className="btn btn-action" onClick={handleclick} value="%">
          %
        </button>
        <button className="btn btn-operator" onClick={handleclick} value="/">
          /
        </button>
      </div>
      <div>
      ...
      <div>
        <button className="btn btn-0" onClick={handleclick} value="0">
          0
        </button>
